package ru.aiwass.java_basic.homeworks.module_2.lesson17.sort;
...
//Алгоритм сортировки:Использовать алгоритм сортировки пузырьков.
...
//Условия выполнения: Реализовать сортировку пузырьков без использования встроенных функций сортировки.
